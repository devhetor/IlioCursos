...
let CourseRepository = class CourseRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, studentRepositoryGetter) {
        super(models_1.Course, dataSource);
        this.studentRepositoryGetter = studentRepositoryGetter;
...
CourseRepository = __decorate([
    ...
    __param(1, repository_1.repository.getter('StudentRepository')),
    __metadata("design:paramtypes", [datasources_1.MysqlDataSource, Function])
], CourseRepository);
